...
enum CoilsRegs
{
    ...
    //模式控制位
    Coils_AutoCtrl = 0x0050,
    Coils_AutoCharge,
    Coils_BL_01_AutoCtrl,
    Coils_BL_02_AutoCtrl,
    Coils_BL_03_AutoCtrl,
    Coils_BL_04_AutoCtrl,
    Coils_PMP_01_AutoCtrl,
    Coils_PMP_02_AutoCtrl,
    Coils_PMP_03_AutoCtrl,
    Coils_PMP_04_AutoCtrl,
    Coils_PMP_05_AutoCtrl,
    Coils_RAD_01_AutoCtrl,

    //报警开关控制位
    Coils_LT_01_AlarmCtrl = 0x0060,
    Coils_LT_02_AlarmCtrl,
};

enum DiscreteInputs_
{
    //IO输入
