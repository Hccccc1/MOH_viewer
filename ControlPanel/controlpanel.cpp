    ...
    current_model(model)
{
    ...
    connect(ui->roundProgressSlider_1, &QSlider::sliderReleased, this, &ControlPanel::releasedHere);
//    connect(ui->roundProgressSlider_1, &QSlider::actionTriggered);
...
void ControlPanel::releasedHere()
{
    qDebug() << __FILE__ << __LINE__ << "released here";
}
    ...
    if (reply->error() == QModbusDevice::NoError)
    {
        ...
        for (int i = 0, total = int(unit.valueCount()); i < total; i++)
        {
            ...
            case CoilsRegs_SV_01:
                io_controls[0].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_02:
                io_controls[1].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_03:
                io_controls[2].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_04:
                io_controls[3].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_05:
                io_controls[4].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_06:
                io_controls[5].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_07:
                io_controls[6].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_08:
                io_controls[7].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_09:
                io_controls[8].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_10:
                io_controls[9].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_11:
                io_controls[10].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_12:
                io_controls[11].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_13:
                io_controls[12].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_14:
                io_controls[13].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_BL_01:
                io_controls[14].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_BL_02:
                io_controls[15].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_BL_03:
                io_controls[16].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_BL_04:
                io_controls[17].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_PMP_01:
                io_controls[18].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_PMP_02:
                io_controls[19].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_PMP_03:
                io_controls[20].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_PMP_04:
                io_controls[21].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_PMP_05:
                io_controls[22].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_RAD_01:
                io_controls[23].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_KM_01:
                io_controls[24].io_ctrl = unit.value(addr);
            ...
            case CoilsRegs_SV_01_CtrlEnable:
                io_controls[0].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_02_CtrlEnable:
                io_controls[1].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_03_CtrlEnable:
                io_controls[2].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_04_CtrlEnable:
                io_controls[3].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_05_CtrlEnable:
                io_controls[4].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_06_CtrlEnable:
                io_controls[5].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_07_CtrlEnable:
                io_controls[6].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_08_CtrlEnable:
                io_controls[7].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_09_CtrlEnable:
                io_controls[8].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_10_CtrlEnable:
                io_controls[9].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_11_CtrlEnable:
                io_controls[10].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_12_CtrlEnable:
                io_controls[11].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_13_CtrlEnable:
                io_controls[12].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_SV_14_CtrlEnable:
                io_controls[13].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_BL_01_CtrlEnable:
                io_controls[14].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_BL_02_CtrlEnable:
                io_controls[15].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_BL_03_CtrlEnable:
                io_controls[16].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_BL_04_CtrlEnable:
                io_controls[17].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_PMP_01_CtrlEnable:
                io_controls[18].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_PMP_02_CtrlEnable:
                io_controls[19].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_PMP_03_CtrlEnable:
                io_controls[20].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_PMP_04_CtrlEnable:
                io_controls[21].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_PMP_05_CtrlEnable:
                io_controls[22].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_RAD_01_CtrlEnable:
                io_controls[23].io_ctrl_enable = unit.value(addr);
            ...
            case CoilsRegs_KM_01_CtrlEnable:
                io_controls[24].io_ctrl_enable = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV01:
                io_controls[0].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV02:
                io_controls[1].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV03:
                io_controls[2].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV04:
                io_controls[3].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV05:
                io_controls[4].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV06:
                io_controls[5].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV07:
                io_controls[6].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV08:
                io_controls[7].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV09:
                io_controls[8].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV10:
                io_controls[9].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV11:
                io_controls[10].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV12:
                io_controls[11].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV13:
                io_controls[12].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_SV14:
                io_controls[13].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_BL01:
                io_controls[14].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_BL02:
                io_controls[15].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_BL03:
                io_controls[16].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_BL04:
                io_controls[17].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_PMP01:
                io_controls[18].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_PMP02:
                io_controls[19].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_PMP03:
                io_controls[20].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_PMP04:
                io_controls[21].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_PMP05:
                io_controls[22].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_RAD01:
                io_controls[23].output_status_feedback = unit.value(addr);
            ...
            case DiscreteInputs_OutputFeedback_KM01:
                io_controls[24].output_status_feedback = unit.value(addr);
            ...
            case HoldingRegs_SpeedCtrl_BL01:
                speed_controls[0].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_1->setValue(speed_controls[0].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_BL02:
                speed_controls[1].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_2->setValue(speed_controls[1].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_BL03:
                speed_controls[2].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_3->setValue(speed_controls[2].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_BL04:
                speed_controls[3].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_4->setValue(speed_controls[3].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_PMP01:
                speed_controls[4].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_5->setValue(speed_controls[4].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_PMP02:
                speed_controls[5].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_6->setValue(speed_controls[5].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_PMP03:
                speed_controls[6].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_7->setValue(speed_controls[6].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_PMP04:
                speed_controls[7].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_8->setValue(speed_controls[7].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_PMP05:
                speed_controls[8].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_9->setValue(speed_controls[8].speed_percentage/10);
                break;
            case HoldingRegs_SpeedCtrl_RAD01:
                speed_controls[9].speed_percentage = unit.value(addr);
                ui->roundProgressSlider_10->setValue(speed_controls[9].speed_percentage/10);
                break;

            case InputRegs_BL_01:
                speed_controls[0].speed_rpm = unit.value(addr);
                ui->speedControl_1->setText(QString::number(speed_controls[0].speed_rpm));
                break;
            case InputRegs_BL_02:
                speed_controls[1].speed_rpm = unit.value(addr);
                ui->speedControl_2->setText(QString::number(speed_controls[1].speed_rpm));
                break;
            case InputRegs_BL_03:
                speed_controls[2].speed_rpm = unit.value(addr);
                ui->speedControl_3->setText(QString::number(speed_controls[2].speed_rpm));
                break;
            case InputRegs_BL_04:
                speed_controls[3].speed_rpm = unit.value(addr);
                ui->speedControl_4->setText(QString::number(speed_controls[3].speed_rpm));
                break;
            case InputRegs_PMP_01:
                speed_controls[4].speed_rpm = unit.value(addr);
                ui->speedControl_5->setText(QString::number(speed_controls[4].speed_rpm));
                break;
            case InputRegs_PMP_02:
                speed_controls[5].speed_rpm = unit.value(addr);
                ui->speedControl_6->setText(QString::number(speed_controls[5].speed_rpm));
                break;
            case InputRegs_PMP_03:
                speed_controls[6].speed_rpm = unit.value(addr);
                ui->speedControl_7->setText(QString::number(speed_controls[6].speed_rpm));
                break;
            case InputRegs_PMP_04:
                speed_controls[7].speed_rpm = unit.value(addr);
                ui->speedControl_8->setText(QString::number(speed_controls[7].speed_rpm));
                break;
            case InputRegs_PMP_05:
                speed_controls[8].speed_rpm = unit.value(addr);
                ui->speedControl_9->setText(QString::number(speed_controls[8].speed_rpm));
                break;
            case InputRegs_RAD_01:
                speed_controls[9].speed_rpm = unit.value(addr);
                ui->speedControl_10->setText(QString::number(speed_controls[9].speed_rpm));
                break;

            case CoilsRegs_BL_01_AutoCtrl:
                speed_controls[0].auto_control = unit.value(addr);
            ...
            case CoilsRegs_BL_02_AutoCtrl:
                speed_controls[1].auto_control = unit.value(addr);
            ...
            case CoilsRegs_BL_03_AutoCtrl:
                speed_controls[2].auto_control = unit.value(addr);
            ...
            case CoilsRegs_BL_04_AutoCtrl:
                speed_controls[3].auto_control = unit.value(addr);
            ...
            case CoilsRegs_PMP_01_AutoCtrl:
                speed_controls[4].auto_control = unit.value(addr);
            ...
            case CoilsRegs_PMP_02_AutoCtrl:
                speed_controls[5].auto_control = unit.value(addr);
            ...
            case CoilsRegs_PMP_03_AutoCtrl:
                speed_controls[6].auto_control = unit.value(addr);
            ...
            case CoilsRegs_PMP_04_AutoCtrl:
                speed_controls[7].auto_control = unit.value(addr);
            ...
            case CoilsRegs_PMP_05_AutoCtrl:
                speed_controls[8].auto_control = unit.value(addr);
            ...
            case CoilsRegs_RAD_01_AutoCtrl:
                speed_controls[9].auto_control = unit.value(addr);
